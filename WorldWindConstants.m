/*
 ...
 @version $Id: WorldWindConstants.m 1861 2014-03-12 01:06:57Z tgaskins $
 */
...
NSString* const WW_CANCELED = @"gov.nasa.worldwind.RetrievalCancelled";
NSString* const WW_FAILED = @"gov.nasa.worldwind.RetrievalFailed";
NSString* const WW_FILE_PATH = @"gov.nasa.worldwind.FilePath";
NSString* const WW_FRACTION = @"gov.nasa.worldwind.Fraction";
...
NSString* const WW_MIME_TYPE = @"gov.nasa.worldwind.MimeType";
NSString* const WW_NAVIGATOR_CHANGED = @"gov.nasa.worldwind.NavigatorChanged";
NSString* const WW_ORIGIN = @"gov.nasa.worldwind.Origin";
NSString* const WW_ORIGINAL_ASPECT = @"gov.nasa.worldwind.OriginalAspect";
NSString* const WW_ORIGINAL_SIZE = @"gov.nasa.worldwind.OriginalSize";
NSString* const WW_PIXELS = @"gov.nasa.worldwind.Pixels";
NSString* const WW_REFRESH = @"gov.nasa.worldwind.Refresh";
NSString* const WW_REFRESH_COMPLETE = @"gov.nasa.worldwind.RefreshComplete";
NSString* const WW_REQUEST_REDRAW = @"gov.nasa.worldwind.RequestRedraw";
NSString* const WW_RESPONSE_CODE = @"gov.nasa.worldwind.ResponseCode";
NSString* const WW_RHUMB = @"gov.nasa.worldwind.Rhumb";
NSString* const WW_START_REDRAWING = @"gov.nasa.worldwind.StartRedrawing";
NSString* const WW_STOP_REDRAWING = @"gov.nasa.worldwind.StopRedrawing";
